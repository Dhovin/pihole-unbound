...
sudo checkinstall --fstrans=0 --pkgname=unbound --pkgversion=1.19.0 --default
#sudo make install
sudo install -v -m755 -d /usr/share/doc/unbound-1.19.0
sudo install -v -m644 doc/html/* /usr/share/doc/unbound-1.19.0
